  ...
  try {
    const networks: INetwork[] = JSON.parse(
      process.env.NETWORKS
        ? process.env.NETWORKS
        : '[{"name":"general","test":false},{"name":"mainnet","test":false},{"name":"polygon","test":false},{"name":"bsc","test":false},{"name":"moonriver","test":false},{"name":"energyweb","test":false},{"name":"mumbai","test":true},{"name":"moonbase","test":true},{"name":"goerli","test":true},{"name":"sepolia","test":true}]'
    )
